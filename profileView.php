		...
		<!-- One -->
			<section id="main" class="wrapper style1 align-center" >
							...
							<div class="col-sm-2">
								<div class="select-wrapper" style="width: auto" >
									<select name="type" id="type" required style="background-color:white;color: black;">
										...
										<option value="dairy" style="color: black;">Dairy Products</option>
									</select>
							  	</div>
							</div>
							<div class="col-sm-2">
				...
				<?php
					...
					if(isset($_GET['type']) AND $_GET['type'] == "dairy")
					{
						$sql = "SELECT * FROM fproduct WHERE pcat = 'Dairy'";
					}
